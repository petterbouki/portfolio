  ...
  return (
    <section id="about" className="section">
      ...
      <p className="section-text">
       ...
       Mes domaines d’intérêt couvrent la vision par ordinateur, la régression et la classification, l’analyse statistique avancée et le déploiement de modèles IA. Je m’intéresse particulièrement aux projets à fort impact dans des secteurs tels que la finance, l’agro-industrie, l’énergie et les services publics.

       Mon objectif est de mettre la data et l’IA au service du développement, en apportant des solutions fiables, innovantes et adaptées aux réalités locales.
      </p>
    </section>
  );
};
